      ...
      <div className="max-w-4xl mx-auto px-5 py-8 space-y-10">
        ...
        <div className="flex flex-col sm:flex-row items-center sm:items-start gap-5">
          <img
            src={LOGO_DATA_URL}
            alt="7กิโล๊ะ"
            className="w-16 h-16 rounded-2xl object-contain shadow-md flex-shrink-0"
          />
          <div>
            <div className="flex items-center gap-2 mb-1">
              <h1 className="text-2xl font-bold text-slate-900">7กิโล๊ะ</h1>
              <span className="px-2 py-0.5 text-[11px] font-semibold bg-indigo-100 text-indigo-700 rounded-full">AI นักสืบ</span>
            </div>
            <p className="text-slate-500 text-sm leading-relaxed max-w-lg">
              ระบบสืบสวนรถโคลนและรถหายด้วย AI — เลือก Agent ที่ตรงกับปัญหา
              หรือแชทกับ <strong className="text-slate-700">7กิโล๊ะ</strong> ตรงๆ แล้วระบบจะพาไปเองครับ
            </p>
